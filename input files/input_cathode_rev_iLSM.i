...
[Materials]
  ...
  [./vacancyDiffFluxCoefficient]
    type  = ParsedMaterial
    block = 'PT_LSM_TET4 PT_TPB_TET4 PT_ILSM_TET4'
  ...
  [./holeConductivity]
    type  = GenericConstantMaterial
    block = 'PT_LSM_TET4 PT_TPB_TET4 PT_ILSM_TET4' # when you use previously generated mesh, you need to use LSM block.
    # block = 'PT_NI_TET4 PT_TPB_TET4'
...
[BCs]
  ...
  [./potentialLSM_top]
    ...
    variable = phi_LSM
    boundary = 'SF_LSM_WITH_XMIN SF_ILSM_WITH_XMIN'
