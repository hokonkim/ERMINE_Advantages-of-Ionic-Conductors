...
[Variables]
  ...
  [./phi_LSM]
    block = 'PT_LSM_TET4 PT_TPB_TET4' # when you use previously generated mesh, you need to use LSM block.
    # block = 'PT_NI_TET4 PT_TPB_TET4'
    initial_condition = 1.07277 # (V) Just for condition: Each subdomain must contain at least one Kernel.
...
[AuxKernels]
  ...
  # [./j_x_Aux]
  #   type = ParsedAux
  #   function = '-(4e-2) * grad_phi_YSZ_X1'
  #   variable = j_X1
  #   args = 'grad_phi_YSZ_X1'
  # [../]
  #
  # [./j_y_Aux]
  #   type = ParsedAux
  #   function = '-(4e-2) * grad_phi_YSZ_Y1'
  #   variable = j_Y1
  #   args = 'grad_phi_YSZ_Y1'
  # [../]
  #
  # [./j_z_Aux]
  #   type = ParsedAux
  #   function = '-(4e-2) * grad_phi_YSZ_Z1'
  #   variable = j_Z1
  #   args = 'grad_phi_YSZ_Z1'
  # [../]
[]
