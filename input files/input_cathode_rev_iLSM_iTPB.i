[Mesh]
  ...
  [./phase_15_interface]
    ...
    master_block = 'PT_PORE_TET4'
    paired_block = 'PT_ILSM_TET4'
    new_boundary = 'interface_15'
  [../]

  [./phase_35_interface]
    type = SideSetsBetweenSubdomainsGenerator
    input = phase_15_interface
    master_block = 'PT_YSZ_TET4'
    paired_block = 'PT_ILSM_TET4'
    new_boundary = 'interface_35'
  [../]
[]
...
[Materials]
  ...
  [./gasDiffFluxCoefficient]
    type  = ParsedMaterial
    block = 'PT_PORE_TET4 PT_TPB_TET4 PT_ITPB_TET4'
  ...
  [./vacancyDiffFluxCoefficient]
    type  = ParsedMaterial
    block = 'PT_LSM_TET4 PT_TPB_TET4 PT_ILSM_TET4 PT_ITPB_TET4'
  ...
  [./vacancyDriftFluxCoefficient]
    ...
    block = 'PT_YSZ_TET4 PT_TPB_TET4 PT_ITPB_TET4'
  ...
  [./holeConductivity]
    type  = GenericConstantMaterial
    block = 'PT_LSM_TET4 PT_TPB_TET4 PT_ILSM_TET4 PT_ITPB_TET4' # when you use previously generated mesh, you need to use LSM block.
    # block = 'PT_NI_TET4 PT_TPB_TET4'
  ...
  [./tpbActivity]
    type  = ParsedMaterial
    block = 'PT_TPB_TET4 PT_ITPB_TET4'
...
[InterfaceKernels]
  [./interfaceSurfaceExchangeFullyCoupled]
    ...
    variable = p_O2
    neighbor_var = V_O
    boundary = 'interface_12 interface_15'
    k = 6.14e-6 # (cm/s)
  [../]
  ...
  [./interfaceChargeTransferFullyCoupled]
    ...
    boundary = 'interface_23 interface_35'
    j0 = 0.193  # (A/cm^2)
